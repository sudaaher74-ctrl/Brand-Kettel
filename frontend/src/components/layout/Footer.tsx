    ...
    <footer className="border-t border-line bg-[#0d0d0d]">
      ...
      <div className="container-px py-14">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            <h3 className="font-display text-sm font-semibold text-accent uppercase tracking-widest">Explore</h3>
          ...
          <div>
            <h3 className="font-display text-sm font-semibold text-accent uppercase tracking-widest">Get in touch</h3>
        ...
        <div className="mt-6 flex flex-col items-start justify-between gap-3 text-xs text-ink-muted sm:flex-row sm:items-center">
