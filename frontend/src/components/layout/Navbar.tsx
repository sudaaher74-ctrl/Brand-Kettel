                          ...
                          >
                            ...
                            {servicesDropdown.map((item, i) => (
                              <Link
                                ...
                                onClick={() => setServicesOpen(false)}
                                className={cn(
                                  'group flex items-start gap-3 px-4 py-4 transition-colors hover:bg-[#202025]',
                              ...
                              >
                                ...
                                <span>
                                  <span className="block text-sm font-medium text-ink-muted group-hover:text-white transition-colors">
                                    {item.label}
                                  </span>
                                  <span className="mt-0.5 block text-xs text-ink-muted opacity-60">
                                    {item.description}
                                  </span>
                                </span>
                              </Link>
