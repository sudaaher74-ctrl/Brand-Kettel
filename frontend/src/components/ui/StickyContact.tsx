...
export default function StickyContact() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      <a
        href="https://wa.me/919999999999" // TODO: Replace with real number
        target="_blank"
      ...
      <a
        href="tel:+919999999999" // TODO: Replace with real number
        className="flex h-14 w-14 items-center justify-center rounded-full bg-slate-900 text-white shadow-lg transition-transform hover:scale-110"
        aria-label="Call Us"
      >
