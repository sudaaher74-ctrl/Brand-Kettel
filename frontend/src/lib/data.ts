...
export const projects: Project[] = [
  {
    ...
    gallery: ['/imgs/commercial/gucci-green.png', '/imgs/commercial/gucci.png', '/imgs/commercial/gucci1.png'],
  ...
  },
  {
    ...
    gallery: ['/imgs/commercial/giva.png', '/imgs/commercial/jwellary.png', '/imgs/commercial/jwellary2.png'],
  ...
  },
  {
    ...
    gallery: ['/imgs/commercial/jwellary.png', '/imgs/commercial/jwellary2.png'],
